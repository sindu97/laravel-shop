...
<head>
  ...
  <title>Elite Management- Owner Login</title>
...
<body class="hold-transition login-page ownerbackground">
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Welcome back Landlord, Please login into your account.</p>

    <form action="<?php echo base_url('Owner-Portal/login/validate_login'); ?>" method="post" id="staff_login1">
      <div class="form-group has-feedback ownerform">
