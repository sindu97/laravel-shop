<?php  $user = $this->session->userdata('admin_handyman_login');
      echo $tenid = $user->city;
      die();
      ?>
            ...
            <div class="box-body">
             ...
             if( $val->appoinment_date !==  $previousValue || $val->appoinment_time !==  $previoustime) {
                ...
                <tr>
                  ...
                  <?php echo $previousValue = $val->appoinment_date;?>
                  <?php echo $previoustime = $val->appoinment_time;?>
