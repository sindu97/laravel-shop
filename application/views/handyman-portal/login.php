...
<head>
  ...
  <title>Elite Management- Handyman Login</title>
...
<body class="hold-transition login-page handymanbackground">
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Welcome back Handyman, Please login into your account.</p>

    <form action="<?php echo base_url('handyman/login/validate_login'); ?>" method="post" id="staff_login1">
      <div class="form-group has-feedback handymanform">
