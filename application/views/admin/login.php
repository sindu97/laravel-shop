...
<head>
  ...
  <title>Elite Management- Admin Login</title>
...
<body class="hold-transition login-page adminbackground">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">Welcome back Admin, Please login into your account.</p>

    <form action="<?php echo base_url('admin/login/validate_login'); ?>" method="post" id="staff_login">
      <div class="form-group has-feedback adminform">
